...
/**
 * SPL class loader for InstagramOAuth classes.
 */
class ClassLoader
{
    const PACKAGE = 'Instagram';

    private static $_path;

    /**
     * Registers ClassLoader as an SPL class loader.
     * Inserts self first, retains existing loaders and __autoload()
     *
     * @param string $path Path to Instagram classes directory
     */
    ...
    /**
     * Attempts to load a Instagram class file.
